...
int Yahtzee_count_one=1;
int Yahtzee_count_two=1;
int main(){
    ...
    while(true){
        ...
        if (player_turn_count==0){
            ...
            cin>>input_four;
            if(input_four=="yes"){
                if(com_num==12 && player_two_expected_score[com_num]>0){
                    Yahtzee_count_two+=1;
                }
                if(player_two_check_list[12]==1 && com_num==12){
                    if(Yahtzee_count_two>1){
                        player_two_score+=100;
                    }else{
                        int special_yahtzee;
                        cout<<"You need to occupy a non-used combination: ";
                        cin>>special_yahtzee;
                        while(true){
                            cin>>special_yahtzee;
                            if(player_two_check_list[special_yahtzee-1]==1){
                                cout<<"It has been occupied. Try again: ";
                            } else {
                                player_two_check_list[special_yahtzee-1]=1;
                                player_turn_count++;
                                break;
                            }
                        }
            ...
            cin>>input_four;
            if(input_four=="yes"){
                if(com_num==12 && player_one_expected_score[com_num]>0){
                    Yahtzee_count_one+=1;
                }
                if(player_one_check_list[12]==1 && com_num==12){
                    if(Yahtzee_count_one>1){
                        ...
                        while(true){
                            cin>>special_yahtzee;
                            if(player_one_check_list[special_yahtzee-1]==1){
                                cout<<"It has been occupied. Try again: ";
                            } else {
                                player_one_check_list[special_yahtzee-1]=1;
                                player_turn_count++;
                                break;
                            }
                        }
