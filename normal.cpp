...
int normal(){
    ...
    while(true){
        ...
        if (player_turn_count==0){
            ...
            cin>>input_four;
            if(input_four=="yes"){
                if(com_num==11 && player_one_expected_score[com_num]>0){
                    Yahtzee_count_two+=1;
                }
                if(player_one_check_list[11]==1 && com_num==12){
            ...
            cin>>input_four;
            if(input_four=="yes"){
                if(com_num==11 && player_two_expected_score[com_num]>0){
                    Yahtzee_count_two+=1;
                }
                if(player_two_check_list[11]==1 && com_num==12){
